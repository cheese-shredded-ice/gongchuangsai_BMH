...
float zhuanpan1[3]={-58.0f , 20.0f , 247.0f};//转盘一号位
float zhuanpan2[3]={102.0f , 20.0f , 273.0f};//转盘二号位
float zhuanpan3[3]={102.0f , 20.0f , 228.0f};//转盘三号位

float fangzhi1[3]={56.0f , 127.0f , 198.4f};//红 放和拿
float fangzhi2[3]={3.0f  , 127.0f , 249.5f};//绿 放和拿
float fangzhi3[3]={59.8f , 127.0f , 298.5f};//蓝 放和拿
...
void na_red(void)
{	
	move_all(fangzhi1[0],1000,200   ,fangzhi1[1],1000,220   ,fangzhi1[2],13);
	set_zhuashou_Angle_he();
	move_all(fangzhi1[0],1000,200   ,20,1000,220   ,fangzhi1[2],13);
	move_all(10.0f,1000,200   ,0,1000,220   ,70,13);
	move_all(0.0f,1000,200   ,20,1000,220   ,70,13);
	set_zhuashou_Angle_kai();
}

void na_green(void)
{
	move_all(fangzhi2[0],1000,200   ,fangzhi2[1],1000,220   ,fangzhi2[2],13);
	set_zhuashou_Angle_he();
	move_all(fangzhi2[0],1000,200   ,20,1000,220   ,fangzhi2[2],13);
	move_all(10.0f,1000,200   ,0,1000,220   ,70,13);
	move_all(0.0f,1000,200   ,20,1000,220   ,70,13);
	set_zhuashou_Angle_kai();
...
void na_blue(void)
{
	move_all(fangzhi3[0],1000,200   ,100,1000,220   ,fangzhi3[2],13);
	move_all(fangzhi3[0],1000,200   ,fangzhi3[1],1000,220   ,fangzhi3[2],13);
	set_zhuashou_Angle_he();
	move_all(fangzhi3[0],1000,200   ,20,1000,220   ,fangzhi3[2],13);
	move_all(10.0f,1000,200   ,0,1000,220   ,70,13);
	move_all(0.0f,1000,200   ,20,1000,220   ,70,13);
	set_zhuashou_Angle_kai();
...
{
	if(task == 0x01){
		time_zhua += move_all(zhuanpan1[0],1000,220   ,zhuanpan1[1],2000,220   ,zhuanpan1[2],11);
		delay_ms1(500);
		set_zhuashou_Angle_he();    time_zhua += 350;
		
		time_zhua += move_all(10.0f,1000,200   ,0,2000,220   ,70,11);
		delay_ms1(100);
		time_zhua += move_all(0.0f,1000,200   ,30,2000,220   ,70,11);//30,2000,220,无延时
		delay_ms1(100);
		set_zhuashou_Angle(45.0f,300);	 time_zhua += 350;

	}else if(task == 0x02){
		time_zhua += move_all(zhuanpan2[0],1000,220   ,zhuanpan2[1],2000,220   ,zhuanpan2[2],11);
		delay_ms1(500);
		...
		time_zhua += move_all(10.0f,1000,200   ,0,2000,220   ,70,11);
		delay_ms1(100);
		time_zhua += move_all(0.0f,1000,200   ,30,2000,220   ,70,11);//
		delay_ms1(100);
		set_zhuashou_Angle(45.0f,300);   time_zhua += 350;

	}else if(task == 0x03){
		time_zhua += move_all(zhuanpan3[0],1000,220   ,zhuanpan3[1],2000,220   ,zhuanpan3[2],11);
		delay_ms1(500);
		set_zhuashou_Angle_he();   time_zhua += 350;
...
void yuantai_na1(uint8_t task)
{
	if(task == 0x01){
		...
		set_zhuashou_Angle(40.0f,300);	 time_zhua += 350;
		time_zhua += move_all(0,1000,220   ,zhuanpan2[1],2000,220   ,zhuanpan2[2],11);
	}else if(task == 0x03){
		set_zhuashou_Angle(40.0f,300);   time_zhua += 350;
		time_zhua += move_all(0,1000,220   ,zhuanpan3[1],2000,220   ,zhuanpan3[2],11);
	}
}
...
void yuantai_na2(uint8_t task)
{
	if(task == 0x01){
		...
		time_zhua += move_all(0.0f,1000,200   ,0,2000,220   ,70,11);
		time_zhua += move_all(0.0f,1000,200   ,30,2000,220   ,70,11);
		set_zhuashou_Angle(45.0f,300);	 time_zhua += 350;
...
{   
	...
	y_origin = (Serial_RxPacket[4]-0x30)*1000+(Serial_RxPacket[5]-0x30)*100+(Serial_RxPacket[6]-0x30)*10+(Serial_RxPacket[7]-0x30);
	float x_center,y_center;//x加物块右移//y+物块下移
	x_origin = x_origin - 320;
	y_origin = y_origin - 125;
